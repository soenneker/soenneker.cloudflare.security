...
public interface ICloudflareSecurityUtil
{
    ...
    ValueTask<ZoneSettingsGetSingleSetting200?> GetSecurityLevel(string zoneId, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsEditSingleSetting200?> UpdateSecurityLevel(string zoneId, string level, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsGetSingleSetting200?> GetWaf(string zoneId, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsEditSingleSetting200?> UpdateWaf(string zoneId, bool enabled, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns>The updated WAF settings</returns>
    ValueTask<ZoneSettingsEditSingleSetting200?> EnableWaf(string zoneId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns>The updated WAF settings</returns>
    ValueTask<ZoneSettingsEditSingleSetting200?> DisableWaf(string zoneId, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsGetSingleSetting200?> GetBrowserIntegrityCheck(string zoneId, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsEditSingleSetting200?> UpdateBrowserIntegrityCheck(string zoneId, bool enabled, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsGetSingleSetting200?> GetAlwaysUseHttps(string zoneId, CancellationToken cancellationToken = default);
    ...
    ValueTask<ZoneSettingsEditSingleSetting200?> UpdateAlwaysUseHttps(string zoneId, bool enabled, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns>The updated Always Use HTTPS settings</returns>
    ValueTask<ZoneSettingsEditSingleSetting200?> EnableAlwaysUseHttps(string zoneId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token</param>
    /// <returns>The updated Always Use HTTPS settings</returns>
    ValueTask<ZoneSettingsEditSingleSetting200?> DisableAlwaysUseHttps(string zoneId, CancellationToken cancellationToken = default);
